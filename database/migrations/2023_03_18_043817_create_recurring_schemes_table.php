...
class CreateRecurringSchemesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('recurring_schemes')) {
            Schema::create('recurring_schemes', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('recurring_schemes');
    }
}
