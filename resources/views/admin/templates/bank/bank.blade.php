...
@endsection
    ...
    @section('content')
        ...
        @include('admin.templates.bank.list')


        @include('admin.templates.bank.add')
        @include('admin.templates.bank.update')
...
{
  var API_URL = "{{ route('admin.bank.list') }}";
    $.ajax({
     url: API_URL,
     method: 'get',
     data: {},
...
function add_row(form)
{
     ...
     var API_URL = "{{ route('admin.bank.store') }}";
    ...
    function get_row(id)
    {
     var API_URL = "{{route('admin.bank.get')}}";
        $.ajax({
            url: API_URL,
            type: 'POST',
     ...
     function update_row()
     {
         ...
         var formData = new FormData(form);
         var API_URL = "{{ route('admin.bank.update') }}";
            $.ajax({
                url: API_URL,
                 type: 'POST',
                 data: formData,
      ...
      Swal.fire({
        ...
        if(t.value == true){ 
            var API_URL = "{{ route('admin.bank.delete') }}";
            $.ajax({
                type: "POST",
                url: API_URL,
