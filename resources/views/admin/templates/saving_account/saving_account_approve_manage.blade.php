<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <section class="content padding-top-0">
            <div class="row">
                <form id="approved_saving_account_form" method="post" name="approved_saving_account_form" >
                {{csrf_field()}}
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-footer">
                            <div class="col-xs-12 text-center">
                                <div class="form-group">
                                    <button type="button" onclick="approved_saving_account()" class="btn btn-flat btn-success">SUBMIT</button>
                                    <a class="btn btn-danger" href="{{route('admin.saving_account.index')}}" title="Cancel email setting">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box-body">
                            <table class="table table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Scheme Name</td>
                                        <td><a href="/SavingAccount/SchemeView/bcb412f5-df96-4110-a1af-000457c924c4" target="_blank"> {{@$row->scheme->scheme_code}} - {{@$row->scheme->name}} </a></td>
                                    </tr>
                                    <tr>
                                        <td>Associate's Name</td>
                                        <td><a href="/Agents/View/ad19f099-f106-4583-997b-d2a34530bd64" target="_blank"> G00007 - aaaaa</a></td>
                                    </tr>
                                    <tr>
                                        <td>Interest Rate</td>
                                        <td> 0.500%</td>
