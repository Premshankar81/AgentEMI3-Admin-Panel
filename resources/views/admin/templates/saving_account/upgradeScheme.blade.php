<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="{{route('admin.saving_account.index')}}">Change Scheme</a></li>
      <li class="active">Change Scheme</li>
   </ol>
</section>
<section class="content">
    <form id="add_update_scheme_form" method="POST" name="add_update_scheme_form" autocomplete="off" >
    {{csrf_field()}}
               ...
               <div class="form-horizontal">
                  <div class="col-md-12">
                     ...
                     <div class="form-group">
                        <label class="col-sm-4">Update from Date <span class="requiredfield">*</span></label>
                        <div class="col-sm-7">
                           <input class="form-control"id="update_scheme_date" name="update_scheme_date" type="date">
                        </div>
                     </div>

                     <div class="form-group">
                        <label class="col-sm-4 control-label">Scheme's Name  <span class="requiredfield">*</span></label>
                        <div class="col-sm-7">
                          <select id="scheme_id" name="scheme_id" class="form-control selectpicker">
