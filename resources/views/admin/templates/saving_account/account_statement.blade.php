...
<div class="col-xs-12">
    <div class="form-group">
            <a target="_block" href="{{route('admin.saving_account.print-statements',array('id' => $row['uuid']))}}?from_date=<?= $_REQUEST['from_date'] ?>&to_date=<?= $_REQUEST['to_date'] ?>" class="btn btn-default flat print-button print-page" id="btnPrint"><i class="fa fa-print"></i> Print</a>
                    <a href="{{route('admin.saving_account.manage',array('id' => $row['uuid']))}}" class="btn btn-default flat"><i class="fa fa-backward"></i> Back </a>
        </form>
    </div>
</div>
</div>
