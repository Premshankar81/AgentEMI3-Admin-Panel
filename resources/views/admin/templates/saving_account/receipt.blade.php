...
<ol class="breadcrumb">
    ...
    <li><a href="{{route('admin.saving_account.manage',array('id' => $row['account']['uuid']))}}">Saving Account - {{$row->account->account_no}}</a></li>
...
@if(!empty(Auth::guard('admin')->user()->pdf_logo))
<img alt="logo" src="{{config('constants.SYSTEM')}}{{Auth::guard('admin')->user()->pdf_logo}}" class="img" ; style="margin: 0 auto;width:100%;height:100%;">
@else
