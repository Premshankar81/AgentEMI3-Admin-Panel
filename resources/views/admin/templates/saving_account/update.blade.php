...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{route('admin.saving_account.index')}}">Saving Account Scheme</a></li>
...
<div class="col-md-12" style="padding-bottom:10px;margin-top:20px ">
        <div class="alert alert-warning alert-dismissible margin-top-10 margin-bottom-0">
            ...
            <p class="ft-16">This saving account is pending for approval &nbsp; <a class="btn btn-danger" href="{{route('admin.saving_account.approve-manage',array('id' => $row['uuid']))}}">Let's Do It!</a></p>
        </div>
  </div>
  @endif
  ...
  <div class="col-md-6">
      <div class="form-horizontal">
          ...
          <div class="form-group">
              ...
              <div class="col-sm-7">
                  <input class="form-control" id="opening_amount" name="opening_amount" type="text" value="{{$row['opening_amount']}}">
              </div>
          </div>
