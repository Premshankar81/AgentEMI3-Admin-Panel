            ...
            <div class="col-md-12">
                <div class="box box-default">
                    <div class="box-header">
                        <div class="pull-left">
                            <a class="btn btn-default" href="{{route('admin.saving_account.passbook-fol1',array('id' => $row['uuid']))}}">
                                <i class="fa fa-print"></i> Print Main Page (Fold-1)
                            </a>
                            <a class="btn btn-default" href="{{route('admin.saving_account.passbook-fol2',array('id' => $row['uuid']))}}">
