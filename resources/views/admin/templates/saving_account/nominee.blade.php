          ...
          <div class="tab-pane active" id="memberinfo">
            <div class="box-body">
              ...
              <?php if(json_decode($row['nominee'])  > 0 ){ ?>
                ...
                <div id="member_nominee_forimagerow"  class="box-body item-row" style="border-bottom: solid 1px;box-shadow: 0px 0px 3px 0px;margin-bottom: 2%;">
    ...
    <select class="form-control required" id="nominee_relation" name="nominee_relation[]">
      ...
      <option <?php if($nominee->nominee_relation == 'wife') { echo 'selected'; } ?> value="wife">Wife</option>
              ...
              <?php }else{ ?>
                ...
                <div class="box-body item-row" style="border-bottom: solid 1px;box-shadow: 0px 0px 3px 0px;margin-bottom: 2%;">
                  <div class="form-horizontal">
