    ...
    <div class="col-md-12">
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
          ...
          <li class="">
            <a href="{{ route('admin.customer.address',array('id' => $row['customer_id'])) }}">Address</a>
          </li>
          <li class="">
            <a href="{{ route('admin.customer.bankDetail',array('id' => $row['customer_id'])) }}">Bank Detail</a>
          </li>
          <li class="active">
            <a href="#" data-toggle="tab" aria-expanded="true">Employement Detail</a>
          </li>
          <li class="">
            <a href="{{ route('admin.customer.electricBillDetail',array('id' => $row['customer_id'])) }}">Electricity Bill Detail</a>
          </li>
          <li class="">
                ...
                <div id="salarieddiv" class="displaynone">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <input class="form-control" id="cust_prof_mobile" maxlength="10" value="{{$row['cust_prof_mobile']}}" name="cust_prof_mobile" type="text" value="" autocomplete="off">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <input class="form-control" id="cust_prof_email" maxlength="50" value="{{$row['cust_prof_email']}}" name="cust_prof_email" type="text" value="" autocomplete="off">
                      </div>
                    </div>
                  </div>
                </div>
