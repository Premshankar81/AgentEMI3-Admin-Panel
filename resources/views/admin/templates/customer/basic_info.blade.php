...
<section class="content">
    ...
    <ul class="nav nav-tabs">
            <li class="active"><a href="#memberinfo" data-toggle="tab" aria-expanded="true">Basic Detail</a></li>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <select class="form-control " id="rating" name="rating"><option value=""></option>
                              <option <?php if($row['rating'] == '1-Star') { echo "selected"; } ?> value="1-Star">1-Star</option>
                              <option <?php if($row['rating'] == '2-Star') { echo "selected"; } ?> value="2-Star">2-Star</option>
                              <option <?php if($row['rating'] == '3-Star') { echo "selected"; } ?> value="3-Star">3-Star</option>
                              <option <?php if($row['rating'] == '4-Star') { echo "selected"; } ?> value="4-Star">4-Star</option>
                              <option <?php if($row['rating'] == '5-Star') { echo "selected"; } ?> value="5-Star">5-Star</option>
                              </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-7">
                      <select class="form-control " id="class_id" name="class_id">
                        ...
                        <?php foreach($Classes as $Class){ ?>
                            <option <?php if($row['class_id'] == $Class['id']) { echo "selected"; } ?> value="{{$Class['id']}}">{{$Class['title']}} [ {{$Class['class_fee']}} ]</option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
