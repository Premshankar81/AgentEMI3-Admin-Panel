      ...
      <div class="row">
          ...
          <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <select id="update_country_id" name="update_country_id" class="form-control selectpicker"  required >
          ...
          <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <select id="update_state_id" name="update_state_id" class="form-control selectpicker"  required >
          ...
          <div class="mb-3">
              ...
              <input type="text" name="update_title" id="update_title" class="form-control " placeholder="Enter City" required />
          </div>
          </div>
