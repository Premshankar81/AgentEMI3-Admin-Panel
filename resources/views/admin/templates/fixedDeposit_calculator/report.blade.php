...
<form action="" method="post" novalidate="novalidate">                
    <a href="#" class="btn btn-default flat print-button print-page" id="btnPrint"><i class="fa fa-print"></i> Print</a>
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{route('admin.fd_calculator.index')}}">Calculator</a></li>
            <li class="active">FD Application</li>
        </ol>
    </section>
                    ...
                    <table class="reporttable">
                        <thead>
                            <tr>
                                ...
                                <th style="width:10%;text-align:center;">Principal Amount</th>
                        ...
                        <tbody>
                            @if($rdCalcualtionArr)
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;">{{$value['fd_date']}}</td>
