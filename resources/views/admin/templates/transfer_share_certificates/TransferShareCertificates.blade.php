          ...
          <div style="margin-right:20px;margin-top:0px;margin-left:20px;">
            <table>
              ...
              <tbody>
                <tr>
                  <td style="padding:5px;">EQUITY SHARES EACH OF Rs. 
                  	<span style="font-weight:bold;"> {{$row->no_of_share}}/-</span> (Nominal value) <br>
                    <br> AMOUNT PAID-UP PER SHARE Rs. <span style="font-weight:bold;"> {{$row->face_value}}/-</span>
                  </td>
                </tr>
              </tbody>
              ...
              <tbody>
                ...
                <tr>
                  <td colspan="2" style="padding:5px;">No. of Shares Held: <span style="font-weight:bold;">{{$row->no_of_share}}</span> (in figures) </td>
                </tr>
                <tr>
            ...
            <table border="1" style="width:100%;padding:5px;border-collapse:collapse;">
              ...
              <tbody>
                  ...
                  <td style="padding:5px;">{{$AllocatedShare['memberFromDetails']['name']}}</td>
                  <td style="padding:5px;">{{$AllocatedShare['lot_number']}}</td>
                  <td style="padding:5px;">{{$AllocatedShare['no_of_share']}}</td>
