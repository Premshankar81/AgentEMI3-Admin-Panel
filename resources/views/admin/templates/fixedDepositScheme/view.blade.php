<section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{route('admin.fixedDepositScheme.index')}}">RD Account Scheme List</a></li>
            ...
            <div class="col-md-6">
                <div class="box box-solid">
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            ...
                            <a class="btn btn-default btn-xs" href="{{route('admin.fixedDepositScheme.edit',array('id' => $row['customer_id']))}}">
                ...
                <div class="box box-solid">
                    <div class="box-header">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-default btn-xs" href="{{route('admin.fixedDepositScheme.address',array('id' => $row['customer_id']))}}">
                                <i class="fa fa-pencil"></i>
                            </a>
                        </div>
                    </div>
