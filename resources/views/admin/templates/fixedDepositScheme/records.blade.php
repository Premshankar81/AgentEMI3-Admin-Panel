   ...
   <td><small class="label label-{{$statusClass}}"><?= ucfirst($row['status']) ?></small></td>
    <td width="10%">
         <div class="d-flex gap-2">
            <div class="edit">
                  <a class="btn btn-default btn-xs" href="{{route('admin.fixedDepositScheme.view',array('id' => $row['unique_code']))}}"><i class="fa fa-eye" aria-hidden="true"></i></a>
