...
@endsection
    ...
    @section('content')
        ...
        @include('admin.templates.ledger.list')


        @include('admin.templates.ledger.add')
        @include('admin.templates.ledger.update')
...
function add_row(form)
{
     ...
     var API_URL = "{{ route('admin.ledger.store') }}";
    ...
    function get_row(id)
    {
     ...
     function update_row()
     {
         ...
         var formData = new FormData(form);
         var API_URL = "{{ route('admin.ledger.update') }}";
            $.ajax({
                url: API_URL,
                 type: 'POST',
                 data: formData,
