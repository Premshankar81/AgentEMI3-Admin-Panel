            ...
            <div class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                 ...
                 <div class="form-group">
                <label class="col-sm-4 control-label">Interest Occured <span class="requiredfield">*</span>
                </label>
                <div class="col-sm-7">
                  <input class="form-control" id="InterestOccured" name="interest_occured" type="text" value="<?= $maturity_interest ?>">
                </div>
              </div>
