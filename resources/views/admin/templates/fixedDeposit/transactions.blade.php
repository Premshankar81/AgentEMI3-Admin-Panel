                     ...
                     <tr role="row">
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <div class="edit">
                                   <a class="btn btn-default btn-xs" title="Print receipt" href="{{route('admin.fixedDeposit.receipt',array('id' => $row['id']))}}"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;Receipt</a>
