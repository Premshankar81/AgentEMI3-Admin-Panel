...
<div class="row">
<form id="approved_fixedDeposit_form" method="post" name="approved_fixedDeposit_form" >
{{csrf_field()}}
    ...
    <div class="box box-solid">
        ...
        <div class="box-footer">
            <div class="col-xs-12 text-center">
                <div class="form-group">
                    <button type="button" onclick="approved_fixedDeposit()" class="btn btn-flat btn-success">SUBMIT</button>
                    <a class="btn btn-danger" href="{{route('admin.fixedDeposit.index')}}" title="Cancel email setting">Cancel</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="box-body">
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr>
                        <td>Scheme Name</td>
                        <td><a href="" target="_blank"> {{@$row->FDscheme->scheme_code}} - {{@$row->FDscheme->name}} </a></td>
                    </tr>
