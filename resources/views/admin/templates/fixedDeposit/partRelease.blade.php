...
<ol class="breadcrumb">
   ...
   <li><a href="{{route('admin.fixedDeposit.index')}}">FD Account</a></li>
                     ...
                     <div class="box-footer">
                        <div class="col-xs-12 text-center">
                           <div class="form-group">
                              ...
                              <a href="{{route('admin.fixedDeposit.manage',array('id' => $row['uuid']))}}" class="btn btn-flat btn-danger"> Cancel </a>
                           </div>
                        </div>
                     </div>
                  </div>
