...
<ol class="breadcrumb">
    ...
    <li><a href="{{route('admin.fixedDeposit.manage',array('id' => $row['fd_account']['uuid']))}}">FD Account - {{$row->fd_account->account_no}}</a></li>
...
<table style="width:100%;font-size: 11px; font-family:Calibri;">
    <tbody>
        ...
        <tr>
            <td>A/c No</td>
            <td>:</td>
            <td style="text-align: right;">{{$row->fd_account->account_no}}</td>
        </tr>
    </tbody>
</table>
