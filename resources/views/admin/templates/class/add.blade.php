       ...
       <div class="row">
            <div class="col-lg-12">
                <div class="mb-3">
                    ...
                    <input type="text" id="title" name="title" class="form-control" placeholder="Class Name" required />
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="mb-3">
                    ...
                    <input type="text" id="class_fee" name="class_fee" class="form-control" placeholder="Class fee" required />
                </div>
            </div>
