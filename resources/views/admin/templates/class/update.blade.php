    ...
    <div class="modal-body">
      <div class="row">
        <div class="col-lg-6">
           ...
           <div class="col-lg-6">
                <div class="mb-3">
                    <label for="update_class_fee" class="form-label">Class fee</label>
                    <input type="text" id="update_class_fee" name="update_class_fee" class="form-control" placeholder="Class fee" required />
                </div>
            </div>
