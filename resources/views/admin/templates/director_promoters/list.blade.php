          ...
          <div class="box">
            <div class="box-header" style="width:100%">
              <h3 class="box-title">{{$data['page_title']}} List 
                <a class="margin-r-10 float-right btn btn-primary " href="{{route('admin.director_promoters.create')}}"><i class="mdi mdi-file-export "></i> Add New</a>  
              </h3>
            </div>
            ...
            <div class="box-body">
              <table id="dataTables_table_init" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    <th>Customer Code</th>
                    <th>Promoter/Director's Name</th>
                    <th>Folio No.</th>
                    <th>DIN</th>
                    <th>Mobile No</th>
