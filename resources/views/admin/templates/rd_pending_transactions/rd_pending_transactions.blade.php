...
@endsection
    ...
    @section('content')
        ...
        @include('admin.templates.rd_pending_transactions.list')
        @include('admin.templates.rd_pending_transactions.update')
...
{
  var API_URL = "{{ route('admin.rd-pending-transation.list') }}";
    $.ajax({
     url: API_URL,
     method: 'get',
     data: {},
    ...
    function get_row(id)
    {
     var API_URL = "{{route('admin.rd-pending-transation.get')}}";
        $.ajax({
            url: API_URL,
            type: 'POST',
    ...
    function update_row()
     {
         ...
         var API_URL = "{{ route('admin.rd-pending-transation.update') }}";
            $.ajax({
                url: API_URL,
                 type: 'POST',
                 data: formData,
