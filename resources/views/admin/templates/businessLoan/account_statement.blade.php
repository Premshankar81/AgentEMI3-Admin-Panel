...
<div class="col-xs-12">
    <div class="form-group">
            ...
            <a href="{{route('admin.businessLoan.manage',array('id' => $row['uuid']))}}" class="btn btn-default flat"><i class="fa fa-backward"></i> Back </a>
        </form>
    </div>
</div>
</div>
...
<li><a href="{{route('admin.businessLoan.manage',array('id' => $row['uuid']))}}">Loan Accounts - {{$row->account_no}} </a></li>
...
<table style="width:100%;border-bottom: 1px solid;font-family: Calibri;font-size:18px;font-weight:400;margin-bottom: 10px;">
    ...
    <table style="width:100%;border-collapse:collapse;" border="1">
        ...
        <tr>
            ...
            <td style="width:30%;padding:5px;">{{@$row->Loanscheme->name}}</td>
        </tr>

        <tr>
            <td style="width:20%;padding:5px;">Interest Rate</td>
            <td style="width:30%;padding:5px;">{{@$row->annual_interest_rate}}%</td>
            <td style="width:20%;padding:5px;">Tenure</td>
            <td style="width:30%;padding:5px;"> <?= ucfirst(@$row->tenure) ?></td>
        </tr>
        <tr>
            ...
            <td style="width:20%;padding:5px;">Loan</td>
            <td style="width:30%;padding:5px;font-weight:bold;"> {{@$row->loan_amount}}</td>
