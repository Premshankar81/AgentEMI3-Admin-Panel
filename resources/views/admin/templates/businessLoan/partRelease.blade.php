...
<ol class="breadcrumb">
   ...
   <li><a href="{{route('admin.fixedDeposit.index')}}">Loan Account</a></li>
   <li class="active">Part Release Amount</li>
</ol>
</section>
<section class="content">
    <form id="add_PartRelease_form" method="POST" name="add_PartRelease_form" autocomplete="off" >
    {{csrf_field()}}
          ...
          <div class="col-md-12">
           <form id="add_PartRelease_form" method="POST" name="add_PartRelease_form" autocomplete="off" >
            ...
            <div class="form-horizontal">
              ...
              <div class="form-group">
                <label class="col-sm-4 control-label">Outstanding Balance as on date</label>
                <div class="col-sm-7">
                  <input class="form-control"id="OutStandingAmount" name="due_amount" readonly="readonly" type="text" value="{{$row->loan_amount}}">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-4 control-label">Interest due but not credied</label>
                <div class="col-sm-7">
                  <input class="form-control" id="InterestNotCredited" name="other_charges" readonly="readonly" type="text" value="0.00">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-4 control-label">Deposit Amount</label>
                <div class="col-sm-7">
                  <input class="form-control"id="DepositAmount" name="advance_amount" type="text" value="0.00">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-4 control-label">Remaining Amount <span class="requiredfield">*</span>
                </label>
                <div class="col-sm-7">
                  <input class="form-control" id="TotalAmount" readonly="readonly"  name="amount_deposit" type="text" value="{{$row->loan_amount}}">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <input value="Part payment" class="form-control " id="Narration" maxlength="50" name="Narration" type="text" value="" autocomplete="off">
                </div>
              </div>
            ...
            <div id="bankaccountdiv" class="displaynone">
              ...
              <div id="SavingAccountlDiv" class="displaynone">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-7">
                  <input value="{{$row->tenure}}" class="form-control " id="tenure"name="tenure" type="text" value="" autocomplete="off">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <input value="{{$row->annual_interest_rate}}" class="form-control " id="tenure"name="tenure" type="text" value="" autocomplete="off">
                </div>
              </div>
               ...
               <div class="col-md-12" id="headaddressdiv">
                  <div class="form-group">
                     <div id="headaddress">
                           ...
                           <span style="font-family: arial; font-size: 12px; color: gray;"><i class="fa fa-phone"></i>&nbsp; {{$row['customer']['mobile']}}<br /><i class="fa fa-envelope-o"></i> </span>{{$row['customer']['email']}} <br />
