...
@endsection
    ...
    @section('content')
        ...
        @include('admin.templates.ledger_type.list')


        @include('admin.templates.ledger_type.add')
        @include('admin.templates.ledger_type.update')
...
{
  var API_URL = "{{ route('admin.ledger_type.list') }}";
    $.ajax({
     url: API_URL,
     method: 'get',
     data: {},
...
function add_row(form)
{
     ...
     var API_URL = "{{ route('admin.ledger_type.store') }}";
    ...
    function get_row(id)
    {
     var API_URL = "{{route('admin.ledger_type.get')}}";
        $.ajax({
            url: API_URL,
            type: 'POST',
     ...
     function update_row()
     {
         ...
         var formData = new FormData(form);
         var API_URL = "{{ route('admin.ledger_type.update') }}";
            $.ajax({
                url: API_URL,
                 type: 'POST',
                 data: formData,
      ...
      Swal.fire({
        ...
        if(t.value == true){ 
            var API_URL = "{{ route('admin.ledger_type.delete') }}";
            $.ajax({
                type: "POST",
                url: API_URL,
