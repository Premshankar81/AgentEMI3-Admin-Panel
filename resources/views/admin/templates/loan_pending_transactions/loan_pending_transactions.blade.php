...
@endsection
    ...
    @section('content')
        ...
        @include('admin.templates.loan_pending_transactions.list')
        @include('admin.templates.loan_pending_transactions.update')
...
{
  var API_URL = "{{ route('admin.loan-pending-transation.list') }}";
    $.ajax({
     url: API_URL,
     method: 'get',
     data: {},
    ...
    function get_row(id)
    {
     var API_URL = "{{route('admin.loan-pending-transation.get')}}";
        $.ajax({
            url: API_URL,
            type: 'POST',
    ...
    function update_row()
     {
         ...
         var API_URL = "{{ route('admin.loan-pending-transation.update') }}";
            $.ajax({
                url: API_URL,
                 type: 'POST',
                 data: formData,
