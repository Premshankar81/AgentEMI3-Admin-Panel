...
@endsection
    ...
    @section('content')
        ...
        @include('admin.templates.ledger_group.list')


        @include('admin.templates.ledger_group.add')
        @include('admin.templates.ledger_group.update')
...
{
  var API_URL = "{{ route('admin.ledger_group.list') }}";
    $.ajax({
     url: API_URL,
     method: 'get',
     data: {},
...
function add_row(form)
{
     ...
     var API_URL = "{{ route('admin.ledger_group.store') }}";
    ...
    function get_row(id)
    {
     var API_URL = "{{route('admin.ledger_group.get')}}";
        $.ajax({
            url: API_URL,
            type: 'POST',
     ...
     function update_row()
     {
         ...
         var formData = new FormData(form);
         var API_URL = "{{ route('admin.ledger_group.update') }}";
            $.ajax({
                url: API_URL,
                 type: 'POST',
                 data: formData,
      ...
      Swal.fire({
        ...
        if(t.value == true){ 
            var API_URL = "{{ route('admin.ledger_group.delete') }}";
            $.ajax({
                type: "POST",
                url: API_URL,
