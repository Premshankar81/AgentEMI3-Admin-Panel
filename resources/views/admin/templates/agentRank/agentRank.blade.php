...
@endsection
    ...
    @section('content')
        ...
        @include('admin.templates.agentRank.list')


        @include('admin.templates.agentRank.add')
        @include('admin.templates.agentRank.update')
...
{
  var API_URL = "{{ route('admin.agentRank.list') }}";
    $.ajax({
     url: API_URL,
     method: 'get',
     data: {},
...
function add_row(form)
{
     ...
     var API_URL = "{{ route('admin.agentRank.store') }}";
    ...
    function get_row(id)
    {
     var API_URL = "{{route('admin.agentRank.get')}}";
        $.ajax({
            url: API_URL,
            type: 'POST',
     ...
     function update_row()
     {
         ...
         var formData = new FormData(form);
         var API_URL = "{{ route('admin.agentRank.update') }}";
            $.ajax({
                url: API_URL,
                 type: 'POST',
                 data: formData,
    ...
    if(t.value == true){ 
        var API_URL = "{{ route('admin.agentRank.delete') }}";
        $.ajax({
            type: "POST",
            url: API_URL,
