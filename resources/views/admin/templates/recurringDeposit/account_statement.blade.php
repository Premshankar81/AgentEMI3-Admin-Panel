...
<div class="col-xs-12">
    <div class="form-group">
            <a target="_block" href="{{route('admin.recurringDeposit.print-statements',array('id' => $row['uuid']))}}?from_date=<?= $_REQUEST['from_date'] ?>&to_date=<?= $_REQUEST['to_date'] ?>" class="btn btn-default flat print-button print-page" id="btnPrint"><i class="fa fa-print"></i> Print</a>
                    <a href="{{route('admin.recurringDeposit.manage',array('id' => $row['uuid']))}}" class="btn btn-default flat"><i class="fa fa-backward"></i> Back </a>
        </form>
    </div>
</div>
</div>
...
<li><a href="{{route('admin.recurringDeposit.manage',array('id' => $row['uuid']))}}">RD Accounts - {{$row->account_no}} </a></li>
...
<table style="width:100%;border-bottom: 1px solid;font-family: Calibri;font-size:18px;font-weight:400;margin-bottom: 10px;">
    ...
    <table style="width:100%;border-collapse:collapse;" border="1">
        ...
        <tr>
            ...
            <td style="width:30%;padding:5px;">{{@$row->RDscheme->name}}</td>
        </tr>
        ...
        <tr>
            ...
            <td style="width:30%;padding:5px;"> <?= ucfirst(@$row->rd_frequency) ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width:20%;padding:5px;">Total Paid EMIs Amount</td>
            <td style="width:30%;padding:5px;font-weight:bold;"><?= number_format($PaidEMI) ?></td>
            <td style="width:20%;padding:5px;">Total Interest Deposited</td>
            <td style="width:30%;padding:5px;font-weight:bold;">0</td>
        </tr>
    </tbody></table>
