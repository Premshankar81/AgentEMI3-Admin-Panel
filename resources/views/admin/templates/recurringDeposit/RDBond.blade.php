...
<table border="1" style="font-size:14px; width:100%;border-collapse:collapse;">
    <tbody>
        ...
        <tr>
            ...
            <td style="width:30%;padding:5px;">{{@$row->RDscheme->scheme_code}} - {{@$row->RDscheme->name}}</td>
        </tr>
        <tr>
...
<table border="1" style="font-size:14px;width:100%;border-collapse:collapse;">
    <tbody>
        ...
        <tr>
            <td style="padding:5px;text-align:center;">₹ {{@$row->rd_amount}}</td>
            <td style="padding:5px;text-align:center;">{{Helper::getFromDate($row->application_date)}}</td>
            <td style="padding:5px;text-align:center;"> {{@$row->rd_tenure}} - Months</td>
            ...
            <td style="padding:5px;text-align:center;">{{@$row->rd_principal}}</td>
