<section class="content-header">
  <h1> DEPOSIT-[{{$row['account_no']}} ] <input id="returnUrl" name="returnUrl" type="hidden" value="" autocomplete="off">
  </h1>
  <ol class="breadcrumb">
            ...
            <div class="form-horizontal">
              ...
              <div class="form-group">
                <label class="col-sm-4 control-label">Due EMI Amount &nbsp; 
                    <!-- <a href="#" onclick="showdueemis('6c194203-cbc8-4dc6-b5d0-b91229591846');"><i class="fa fa-gear"></i> Due EMIs </a> -->
                </label>
                <div class="col-sm-7">
                  <input class="form-control"id="due_amount" name="due_amount" readonly="readonly" type="text" value="{{$due_amount}}">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <input class="form-control"id="advance_amount" name="advance_amount" readonly="readonly" type="text" value="0.00">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <input class="form-control" id="PenaltyCharge" name="penalty_charge" readonly="readonly" type="text" value="0.00">
                </div>
              </div>
              <div class="form-group">
