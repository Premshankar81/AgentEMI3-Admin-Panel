 ...
 <tr role="row">
    ...
    <td><small class="label label-{{$statusClass}}"><?= ucfirst($row['status']) ?></small></td>
      <td class=" text-center"><a class="btn btn-success btn-xs" href="{{route('admin.businessLoan.approve-manage',array('id' => $row['uuid']))}}"><i class="fa fa-check" aria-hidden="true"></i>&nbsp;Approve</a></td>
</tr>
