...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sign In |  {{$setting['business_name']}}</title>
    ...
    <!-- App Css-->
    <link href="{{ URL::to('admin/assets/css/app.min.css')}}" rel="stylesheet" type="text/css" />
    <!-- custom Css-->
    <link href="{{ URL::to('admin/assets/css/custom.min.css')}}" rel="stylesheet" type="text/css" />
    <style type="text/css">
        a.d-inline-block.auth-logo {
            color: white;
            font-size: 20px;
        }
    </style>
...
<body>
                                ...
                                <div class="p-2 mt-4">
                                    <form method="POST" action="{{ route('admin.adminlogin') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="username" name="email" :value="old('email')" required autofocus placeholder="Enter username">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password" class="form-control pe-5" placeholder="Enter password" id="password-input" name="password" required autocomplete="current-password">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> {{$setting['business_name']}}.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <!-- particles js -->
    <script src="{{ URL::to('admin/assets/libs/particles.js/particles.js')}}"></script>
    <!-- particles app js -->
    <script src="{{ URL::to('admin/assets/js/pages/particles.app.js')}}"></script>
    <!-- password-addon init -->
    <script src="{{ URL::to('admin/assets/js/pages/password-addon.init.js')}}"></script>
</body>
</html>